"""CLI entrypoint for smolagents lab."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Feature delivery pipeline (smolagents).")
    parser.add_argument(
        "request",
        nargs="?",
        default=None,
    ...
    parser.add_argument(
        "--quiet",
        action="store_true",
        help="Reduce smolagents internal Step N output (errors only)",
    )
